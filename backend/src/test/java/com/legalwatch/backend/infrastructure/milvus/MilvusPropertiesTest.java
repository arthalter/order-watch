package com.legalwatch.backend.infrastructure.milvus;
    ...
    void bindsMilvusProperties() {
        contextRunner
                .withPropertyValues(
                        ...
                        "milvus.port=19530",
                        "milvus.collection-name=legal_sop_chunks",
                ...
                .run(context -> {
                    ...
                    assertThat(properties.getCollectionName()).isEqualTo("legal_sop_chunks");
